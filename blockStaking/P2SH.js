...
function buildAddress(h) {
  ...
  // console.log(bs58Address);

  return bs58.default.encode(bs58Address);
}

function main() {
  const script = Buffer.from("OP_HASH160 OP_PUSHBYTES_20 748284390f9e263a4b766a75d0633c50426eb875 OP_EQUAL", "ascii");
  const hashScript = dubleHash(script);
  // console.log(hashScript);

  console.log(buildAddress(hashScript));
